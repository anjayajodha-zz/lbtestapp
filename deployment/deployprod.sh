...
#parameter file path
parametersFilePath="prodparameters.json"
...
azure group deployment create --name $deploymentName --resource-group $resourceGroupName --template-file $templateFilePath --parameters-file $parametersFilePath --mode "Complete" -q